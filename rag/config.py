...
SUMMARY_LLM_PROVIDER = "aliyun"   # 生成摘要使用的 LLM："ollama" | "davy" | "aliyun"
...
# 实体/关系抽取 LLM 配置
GRAPH_EXTRACT_LLM_PROVIDER = "aliyun"   # "ollama" | "davy" | "aliyun"
...
GRAPH_VALIDATE_LLM_PROVIDER = "aliyun"  # "ollama" | "davy" | "aliyun"（aliyun 用 ALIYUN_VALIDATE_MODEL）
